...
//! - [`register`] - Register file management with 32 general-purpose registers and program counter
//!
...
//! |---------------|---------|---------|
//! | 0-511 | Instruction Memory | Loaded via `load_instructions()`, 256 instructions max |
//! | 512-1023 | Data Memory | General-purpose data storage, accessible via load/store |
//! | Stack (x2) | Stack Pointer | Initialized to address 256 |
//!
